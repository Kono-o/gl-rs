...
pub trait HasContext: __private::Sealed {
   ...
   unsafe fn get_active_uniform(&self, program: Self::Program, index: u32)
   ...
   unsafe fn map_buffer_range(&self, target: u32, offset: i32, length: i32, access: u32)
      -> *mut u8;
   ...
   unsafe fn get_uniform_indices(&self, program: Self::Program, names: &[&str])
      -> Vec<Option<u32>>;
